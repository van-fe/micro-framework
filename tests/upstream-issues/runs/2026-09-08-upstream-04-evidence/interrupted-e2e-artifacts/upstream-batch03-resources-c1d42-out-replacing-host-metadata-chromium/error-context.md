...
```
Error: page.evaluate: AggregateError: All application entries failed for metadata (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).
    ...
    at async eval (eval at evaluate (:311:30), <anonymous>:3:20)
...
+ Array [
+   Object {
+     "message": "AggregateError: All application entries failed for metadata (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).",
+     "name": "metadata",
+     "phase": "mount",
+   },
+ ]
