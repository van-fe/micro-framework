...
- Name: upstream-batch03-resources.spec.ts >> Q3056 W995 keep explicit child API origin and host Axios baseURL during Vue Router guards
- Location: tests/e2e/upstream-batch03-resources.spec.ts:37:1

# Error details

```
Error: page.evaluate: AggregateError: All application entries failed for api-child (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).
    at #k (http://127.0.0.1:5173/@fs/Users/fanfangbo/workspace/micro-framework/packages/runtime-core/dist/index.js:405:9)
    at async #C (http://127.0.0.1:5173/@fs/Users/fanfangbo/workspace/micro-framework/packages/runtime-core/dist/index.js:191:28)
    ...
    at async eval (eval at evaluate (:311:30), <anonymous>:3:22)
...
+ Array [
+   Object {
+     "message": "AggregateError: All application entries failed for api-child (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).",
+     "name": "api-child",
+     "phase": "mount",
+   },
+ ]
