...
```
Error: page.evaluate: AggregateError: All application entries failed for images (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).
...
+ Array [
+   Object {
+     "message": "AggregateError: All application entries failed for images (attempt 1: Cannot read properties of null (reading 'HTMLLinkElement')).",
+     "name": "images",
+     "phase": "mount",
+   },
+ ]
